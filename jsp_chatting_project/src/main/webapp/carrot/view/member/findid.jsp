	...
	<div class="container loginpage">
		<div class="row">
			<div class="card offset-3 col-md-6" style="max-width: 350px; margin:0 auto;">
				...
				<div class="my-2">
					<input type="text" placeholder="이름을 입력하세요." class="form-control" id="name" onchange="findidcheck();">			
				</div>
				<div class="my-2">
					<input type="text" placeholder="이메일을 입력하세요." class="form-control" id="email" onchange="findidcheck();">			
				</div>
				<div>
					<span id="emailresult"></span>
				</div>
				<div class="my-2">
					<button id="findid" class="btn btn-lg btn-block" style="background: #3f7d1b; color: #ffaa21;">아이디찾기</button>
				</div>
